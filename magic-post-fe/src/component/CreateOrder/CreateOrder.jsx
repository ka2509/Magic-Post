 ...
 *
 * @component
 * @returns {JSX.Element} CreateOrder component
 */
function CreateOrder() {
    ...
    useEffect(() => {
        ...
        const fetchDistrict = async () => {
            try {
                const data = await DistrictServices.getDistrictFromProvice(
        ...
        <div className="createForm">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <input
                    ...
                    required
                />
                <label>Sender Tel:</label>
                <input
                    type="text"
                    name="sender_tel"
                    value={formData.sender_tel}
                    onChange={handleChange}
                    required
                />
                ...
                <select
                    ...
                    value={formData.order_instruction}
                    onChange={handleChange}
                >
                    <option key="cancel" value="cancel">
                        Cancel
                    </option>
                    <option key="send_back_immediately" value="send_back_immediately">
                        Send Back Immediately
                    </option>
                    <option key="send_back_inday" value="send_back_inday">
                        Send Back Within The Same Day
                    </option>
                    <option key="call_sender" value="call_sender">
                        Call The Sender
                    </option>
                    <option key="send_back_expired" value="send_back_expired">
                ...
                <select
                    type="text"
                    name="type_order"
                    value={formData.type_order}
                    onChange={handleChange}
                >
                    <option key="documents" value="documents">
                        Document
                    </option>
