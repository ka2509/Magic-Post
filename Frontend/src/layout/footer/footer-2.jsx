...
const FooterTwo = () => {
    ...
    return (
        <footer>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-4 col-xl-3 col-md-6 col-sm-6">
                            <div className="footer-widget footer3-widget footer3-widget1 mb-50 pr-20">
                        ...
                        <div className="col-lg-4 col-xl-3 col-md-6 col-sm-6">
                            <div className="footer-widget footer3-widget footer3-widget2 mb-50 pl-10">
                                <div className="footer-widget-title">
                                    <h4>other pages</h4>
                                </div>
            ...
            <div className="footer__bottom-area p-relative">
                <div className="footer-menu-area position p-absolute">
                    <div className="container">
                        <div className="theme-bg clip-box-xs">
                                ...
                                <div className="row align-items-center">
                                    ...
                                    <div className="col-xxl-5 col-lg-7">
                                        <div className="footer-brand m-img mb-15 text-center text-lg-end">
                                            <Image src={footerIcon} style={{ width: "100%", height: "auto" }} alt="footer icon" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="copy-right-area grey-bg-2">
                    <div className="container">
                        <div className="copy-right-text copy-right-text-3 text-center">
